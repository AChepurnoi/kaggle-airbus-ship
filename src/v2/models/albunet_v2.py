...
from src.v2.loss import MixedLoss, LovaszSymLoss, FocalLoss, FocalLovasz
...
class AlbuNet(nn.Module):
    ...
    def __init__(self, num_classes=1, pretrained=True, is_deconv=True):
        ...
        self.encoder = pretrainedmodels.__dict__['resnet34'](pretrained='imagenet')
    ...
    def freeze_decoder(self):
        freeze_params(self.center.parameters())
        freeze_params(self.dec5.parameters())
        freeze_params(self.dec4.parameters())
        freeze_params(self.dec3.parameters())
        freeze_params(self.dec2.parameters())
        freeze_params(self.dec1.parameters())
        freeze_params(self.dec0.parameters())
